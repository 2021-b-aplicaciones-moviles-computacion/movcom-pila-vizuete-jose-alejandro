...
class DRestaurant : AppCompatActivity() {
    var query: Query? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_drestaurant)
        ...
        val botonConsultar = findViewById<Button>(R.id.btn_consultar_restaurante)
        botonConsultar.setOnClickListener{
            //consultar()
        }
    }
    fun crearRestaurante(){
        val editTextNombre = findViewById<EditText>(R.id.et_restaurante_nombre)
        ...
        referencia.add(nuevoRestaurante)
            .addOnSuccessListener { editTextNombre.text.clear() }
    ...
    fun consultar() {
        //Tipos de consultas en el firestore
        /*
             < less than
